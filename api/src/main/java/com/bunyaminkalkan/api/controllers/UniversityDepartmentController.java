...
public class UniversityDepartmentController {
    ...
    @GetMapping("/universities/{uniId}")
    public UniversityResponse getUniversityById(@PathVariable Long uniId){
        return universityDepartmentService.getUniversityById(uniId);
    }
